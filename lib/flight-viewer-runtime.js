...
const METAR_CLOUD_STYLES = {
  FEW: {
    ...
    underside: "rgb(104, 127, 160)",
    glow: "rgba(206, 223, 246, 0.2)",
    label: "#dce8f5"
  },
  SCT: {
    puffCount: 6,
    ...
    layerDepthWorld: 2.1,
    fill: "rgb(228, 238, 249)",
    underside: "rgb(102, 124, 156)",
    glow: "rgba(206, 223, 246, 0.22)",
    label: "#dce8f5"
  },
  BKN: {
    puffCount: 8,
    ...
    alpha: 0.35,
    layerDepthWorld: 2.4,
    fill: "rgb(224, 233, 244)",
    underside: "rgb(96, 116, 146)",
    glow: "rgba(201, 216, 238, 0.24)",
    label: "#e0e9f5"
  },
  OVC: {
    puffCount: 10,
    ...
    alpha: 0.41,
    layerDepthWorld: 2.7,
    fill: "rgb(220, 229, 239)",
    underside: "rgb(90, 108, 136)",
    glow: "rgba(196, 209, 229, 0.26)",
    label: "#e4ebf5"
  },
  VV: {
    puffCount: 9,
    ...
    alpha: 0.43,
    layerDepthWorld: 2.6,
    fill: "rgb(216, 226, 237)",
    underside: "rgb(84, 101, 128)",
    glow: "rgba(188, 202, 224, 0.24)",
    label: "#e4ebf5"
  },
  OVX: {
    puffCount: 9,
...
function classifyPairConflict(left, right) {
  ...
  return {
    ...
    title: `${getFlightDisplayName(left)} and ${getFlightDisplayName(right)} are compressing`,
...
function updateAirportList() {
  ...
  state.airports.forEach((airport) => {
    ...
    const weatherSummary = formatAirportWeatherSummary(airport)
...
function drawCloudPuff(projected, radiusX, radiusY, style, opacity) {
  ...
  ctx.shadowBlur = clamp(radiusX * 0.9, 4, 16)
  ctx.beginPath()
